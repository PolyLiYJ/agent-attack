...
class DirectPromptConstructor(PromptConstructor):
    ...
    def construct(
        ...
        url = page.url
        previous_action_str = meta_data.get("action_history", ["None"])[-1]
...
class MultimodalCoTPromptConstructor(CoTPromptConstructor):
    ...
    def construct(
        ...
        print(f"[DEBUG] construct: page_screenshot_img type = {type(page_screenshot_img)}, images type = {type(images)}")
